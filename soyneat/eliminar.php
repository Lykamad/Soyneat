...
<body>
    ...
    <h2>Para eliminar tu usuario primero vuelve a introducir tus datos</h2>
    <div class="content">
       
       <form action="eliminar_usuario.php" method="POST" name="form" enctype="multipart/form-data">
